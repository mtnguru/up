 ...
 */
function olive_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $form['olive_settings']['olive_utilities'] = [
    '#type' => 'fieldset',
    '#title' => t('Olivero Utilities'),
  ];
  $form['olive_settings']['olive_utilities']['mobile_menu_all_widths'] = [
    '#type' => 'checkbox',
  ...
  $form['olive_settings']['olive_utilities']['site_branding_bg_color'] = [
    '#type' => 'select',
