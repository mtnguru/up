...
(function (Drupal, once) {
  ...
  function checkIfDesktopNavigationWraps(entries) {
    ...
    if (Drupal.olive.isDesktopNav() && entries[0].contentRect.height > navItem.clientHeight) {
  ...
  Drupal.behaviors.automaticMobileNav = {
    attach: function attach(context) {
      once('olive-automatic-mobile-nav', '[data-drupal-selector="primary-nav-menu--level-1"]', context).forEach(init);
    }
  };
})(Drupal, once);