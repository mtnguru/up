...
((Drupal) => {
  const { isDesktopNav } = Drupal.olive;
  ...
  Drupal.olive.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.olive.isDesktopNav()) return;
  ...
  Drupal.olive.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.olive.areAnySubNavsOpen = areAnySubNavsOpen;
