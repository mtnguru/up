...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.olive.areAnySubNavsOpen()) {
          props.olive.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.oliveNavigation = {
    attach(context) {
